...
public class LargeInterComponentExample {
  ...
  public LargeInterComponentExample() {
    EFSMBuilder<
            ...
            Param,
            EEFSMContext<Object>,
            ETransition<State, Param, Object>,
    ...
    builder.withTransition(
        example3.oR1, example2.oR2, new ETransition<>(example3.EvtBack, null, null, null, null));
    ...
    builder.withTransition(
        example4.oR1, example2.oR2, new ETransition<>(example4.EvtBack, null, null, null, null));
    ...
    builder.withTransition(
        example5.oR1, example4.oR2, new ETransition<>(example5.EvtBack, null, null, null, null));
    ...
    builder.withTransition(
        ...
        example6.oC1,
        new ETransition<>(
            e6Entry, new Object[] {example1.Le}, null, new ContextVar[] {additionalContext}, null));
    builder.withTransition(
        example6.oR1, example5.oR2, new ETransition<>(example6.EvtBack, null, null, null, null));
