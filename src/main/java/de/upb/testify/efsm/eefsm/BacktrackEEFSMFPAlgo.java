 ...
 * created on 02.03.18
 */
public class BacktrackEEFSMFPAlgo<State extends Comparable<State>, Input, ContextObject> extends JGraphBasedFPALgo<State, Input, EEFSMContext<ContextObject>, ETransition<State, Input, ContextObject>> {
