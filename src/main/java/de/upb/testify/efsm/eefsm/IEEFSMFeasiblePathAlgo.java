...
public interface IEEFSMFeasiblePathAlgo<State, Input, ContextObject>
  ...
  @Override
  EEFSMPath<State, Input, ContextObject> getPath(
      Configuration<State, EEFSMContext<ContextObject>> config, State tgt);

  @Override
  List<EEFSMPath<State, Input, ContextObject>> getPaths(State tgt);

  @Override
  List<EEFSMPath<State, Input, ContextObject>> getPaths(
      Configuration<State, EEFSMContext<ContextObject>> config, State tgt);
}
