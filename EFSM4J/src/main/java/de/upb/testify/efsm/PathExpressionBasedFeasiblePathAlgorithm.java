 ...
 * created on 13.03.18
 */
public abstract class PathExpressionBasedFeasiblePathAlgorithm<State, Parameter, Context extends IEFSMContext<Context>, Transition extends de.upb.testify.efsm.Transition<State, Parameter, Context>> implements IFeasiblePathAlgo<State, Parameter, Context, Transition> {
  private final static Logger logger = LoggerFactory.getLogger(PathExpressionBasedFeasiblePathAlgorithm.class);
  ...
  public PathExpressionBasedFeasiblePathAlgorithm(EFSM<State, Parameter, Context, Transition> efsm) {
    this(efsm, Integer.MAX_VALUE);
  }


  public PathExpressionBasedFeasiblePathAlgorithm(EFSM<State, Parameter, Context, Transition> efsm, int maxDepth) {
