 ...
 * created on 07.03.18
 */
public class PathExpressionBasedAllFeasiblePaths<State, Parameter, Context extends IEFSMContext<Context>, Transition extends de.upb.testify.efsm.Transition<State, Parameter, Context>> extends PathExpressionBasedFeasiblePathAlgorithm<State, Parameter, Context, Transition> {

  public PathExpressionBasedAllFeasiblePaths(EFSM<State, Parameter, Context, Transition> efsm) {
    super(efsm, Integer.MAX_VALUE);
  }


  public PathExpressionBasedAllFeasiblePaths(EFSM<State, Parameter, Context, Transition> efsm, int maxDepth) {
    super(efsm, maxDepth);
  }
